...
export function renderButton(data: ButtonData): string {
  ...
  <text x="${ARC_CX}" y="80" font-size="11" fill="white" fill-opacity="0.6" text-anchor="middle"
        dominant-baseline="central" font-family="-apple-system, 'Helvetica Neue', Arial, sans-serif">SESSION</text>
  <line x1="14" y1="110" x2="130" y2="110" stroke="white" stroke-opacity="0.2" stroke-width="1"/>
  <text x="44" y="127" font-size="13" fill="white" text-anchor="middle"
        dominant-baseline="central" font-family="-apple-system, 'Helvetica Neue', Arial, sans-serif">${escapeXml(weeklyLabel)}</text>
  ${resetStr ? `<text x="100" y="127" font-size="13" fill="white" text-anchor="middle"
